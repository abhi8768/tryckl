...
class ListingDetail extends Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps, prevProps, prevState) {
    ...
    if (
      prevProps.acceptlistflag !== nextProps.acceptlistflag &&
      nextProps.acceptlistflag === true
    ) {
      ToastsStore.success("Card Accepted Successfully");
      nextProps.clearacceptListSuccess();
    ...
    if (
      ...
      let id = nextProps.nowchangeview.substr(
        14,
        nextProps.nowchangeview.length - 14
      );
      this.setState(
        {
          listingid: id,
        ...
        function () {
          this.props.requestDetaillisting({
            listing_id: this.state.listingid,
          });
        }
      );
  ...
  paymentIntemt() {
    paymentIntentData.account =
      this.state.detail.card_owner_payment_onboard_acc_id; //"acct_1I9op8Qfo3fkSpab"
  ...
  render() {
    ...
    let letterImage =
      ...
      detail.accepted_by_name !== undefined &&
      detail.accepted_by_name !== null
        ? detail.accepted_by_name.charAt(0)
        : "";
    let MapWithAMarker;
    console.log(
      ...
      MapWithAMarker = withScriptjs(
        withGoogleMap((props) => (
          <GoogleMap
            defaultZoom={15}
            defaultCenter={{
              lat: Number(detail.property_latitude),
              lng: Number(detail.property_longitude),
            }}
          >
            <Marker
              position={{
    ...
    return (
      <div className="row">
              ...
              <div className="content-part-wrapper profile-content-part-wrapper list-pre">
                ...
                <div className="content-part-wrapper dark-part position-relative">
                  ...
                  {mls.map((sinsle_mls, index) => {
                    ...
                    return (
                      <p key={`mls${index}`} className="ohters-color2 mt-3">
                        {sinsle_mls.mls_name}
                        <span className="float-right">
                          {" "}
                          <a target="_blank" href={rs}>
                            <img src="/assets/img/www-img.png" />
                          </a>
                        </span>
                      </p>
                    );
                  ...
                  <div className="content-part-wrapper dark-part position-relative">
                    ...
                    <div className="item user-block  d-flex align-items-center">
                        ...
                        <div className="user-block-status">
                          {detail.accepted_by_profile_photo != "" ? (
                            <img
                              ...
                              src={detail.accepted_by_profile_photo}
                              alt="Avatar"
                      ...
                      <div className="profile2-list-txt ohters-color2">
                        <p
                          className="ohters-color2"
                          onClick={() => this.gotoProfile(detail.card_owner_id)}
                        >
                          {detail.accepted_by_name}
                        </p>
                      </div>
                ...
                {this.props.match.params.offer === undefined &&
                  detail.listing_status == "ACCEPTED" && (
                    <button
                      className="sv-btn"
                      id="cancel-listing"
                      onClick={this.checkcancelStatus}
                    >
                      Cancel Listing
                    </button>
                  )}
                ...
                {detail.listing_status === "ACCEPTED" &&
                  this.props.match.params.offer !== undefined && (
                    <button
                      ...
                      id="cancel-listing"
                      onClick={() => {
                        this.props.checkreturncardstatus(this.state.listingid);
                      }}
                    >
                      Return Card
                    </button>
        ...
        <Modal
          ...
          center
        >
          <div className="modal-header2"></div>
          <div className="modal-body" style={customStyles}>
            <Card
              forCancellation={this.paymentforcancellation}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    clearacceptListSuccess: bindActionCreators(
      clearacceptListSuccess,
      dispatch
    ),
    clearreturnListSuccess: bindActionCreators(
      clearreturnListSuccess,
      dispatch
    ),
    checkreturncardstatus: bindActionCreators(checkreturncardstatus, dispatch),
