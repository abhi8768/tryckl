          ...
          <ul className="navbar-nav mr-auto flex-row position-custom">
            <li className="nav-item no-border">
              <a
                ...
                href={void 0}
                onClick={this.menuCollanse}
                data-trigger-resize=""
                data-toggle-state="aside-collapsed"
              >
                <em className="">
                  <img
                    className="img-fluid sand"
                    src="/assets/img/nav-nenu-ico.png"
                  />
                </em>
              </a>
            ...
            <li
              className="nav-item d-none d-md-block dropdown"
              id="listing-header-icon"
            >
              <a
                onClick={this.linktomylisting}
                className="nav-link"
                id="user-block-toggle"
                href={void 0}
                data-toggle="collapse"
