   ...
   render() {
    ...
    return (
      <div className="wrapper">
        ...
        <section className="section-container overflow_auto">
                    ...
                    <div className="item user-block user-part">
                      <div className="user-block-picture custom-user-block-picture">
                        <div className="user-block-status">
                          {profile.profile_photo != "" ? (
                            <img
                              className="img-thumbnail rounded-circle dashboard-thumbnail"
                      ...
                      <div className="user-info-wrapper">
                        ...
                        <p className="user-address">
                          ...
                          {profile.street_name},{profile.city},
                          <a href={`skype: ${profile.phone}`}>
                            {profile.phone}
                          </a>
                          <a
                          ...
                          {profile.license_issuing_state_code} Lic. #
                          {profile.license_no}
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-lg-6">
                  <div className="content-part-wrapper">
                    ...
                    {notificationlist.map((item, index) => {
                      ...
                      return (
                        <div
                          className="content-part-wrapper light-part"
                          key={`notification${index}`}
                          onClick={() => this.gotoDetailown(item.content_id)}
                        >
                          <div className="row dashboard-loop">
                            <div className="col-sm-9 d-flex align-items-center">
                              ...
                              <div className="secend-block">
                                <p className="user-name">
                                  <Link
                                    to={`/profile/${encrypt(
                                      item.notification_from_broker_id
                                    )}`}
                                  >
                                    {item.sender_name}
                                  </Link>
                ...
                <div className="col-lg-3">
                  <div className="content-part-wrapper">
                    <h2 className="mid-heading">
                      my listings <Link to="/my-listing">View All</Link>
                    </h2>
                    {list.map((item2, index) => {
                      ...
                      return (
                        <div
                          className="content-part-wrapper dark-part"
                          key={`mylist${index}`}
                          onClick={() => this.gotoDetail(item2.listing_id)}
                        >
                          <h2 className="card-amount">
                            {item2.type == "Open House"
                              ? "leads"
                              : `$ ${item2.offer_amount}`}
                          ...
                          <p className="ohters-color2">
                            {item2.date} &nbsp; {item2.time}
                          </p>
                        </div>
                      );
                    })}
