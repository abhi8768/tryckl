      ...
      <div className="form-container sign-in-container">
        ...
        <form onSubmit={this.onSubmit}>
          ...
          <div className="frm-wrapper text-left">
            ...
            />
            <Link to="/forget-userid" className="forg">
              Forgot User ID?
            </Link>
            ...
            <label className="container-check float-left">
            ...
            <Link to="/forget-password" className="float-right forg">
              Forgot password?
            </Link>
            ...
            <div className="help-center">
              <p>
                {/*   <a href="">Login Help </a> */}
                <Link to="/contact-us" className="float-right">
                  Contact Us
                </Link>
