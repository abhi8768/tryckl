							...
							<div className="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div className="row">
									<div className="col-sm-12 col-xs-12">
										<div className="mb-30">
											<h3 className="text-center txt-dark mb-10">Sign in to Tryckl</h3>
										...
										<div className="form-wrap">
											<form action="#" onSubmit={this.onSubmit}>
												...
												<div className="form-group">
													...
													<a className="capitalize-font txt-danger block mb-10 pull-right font-12" href="forgot-password.html">forgot password ?</a>
