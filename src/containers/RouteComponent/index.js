    ...
    return (
      <main>
        ...
        <Switch>
          ...
          <PrivateRoute
            exact={true}
            path={pathList.paymentcheckout.path}
            title={pageTitles.paymentcheckout}
            component={routes.PaymentCheckout}
          />
          <PrivateRoute
            exact={true}
          ...
          <PrivateRoute
            exact={true}
            path={pathList.bankadd.path}
            title={pageTitles.bankadd}
            component={routes.BankAdd}
          />
          <PrivateRoute
            exact={true}
