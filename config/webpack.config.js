const webpack = require("webpack"),
  ...
  apiURLPrefix = {
    production: JSON.stringify("https://stagingapi.tryckl.com/api/v1"), //https://api.tryckl.com/api/v1
    //development: JSON.stringify('http://localhost:3000/api/v1') //https://stagingapi.tryckl.com/api/v1
  ...
  cryptoKey = {
    production: {
      ...
      Base64:
        "iJg92iHO+tYOawijWLvPDE/jJPEtVlcjMY5gt9shUck6Fnvgo/XnwQqSJeXYanL+ZhkiqEUbJNqmaE7VslK0xw==",
    },
    development: {
      type: "HMAC-SHA512",
      message: "Tryckl2021@JAN#1!!!",
      ...
      Base64:
        "qTxO6YQDunVQgTdiQkPossF80XESXC+npsq5iTdULpah2shaKSWmRULv+kxBCHSFl1e3kEn2DR75ujUuqY03yA==",
    },
  },
  stats = {
    hash: false,
  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        {
          from: "./src/landing_assets/webfonts",
          to: "landing_assets/webfonts/",
        },
